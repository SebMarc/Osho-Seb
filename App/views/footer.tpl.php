        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-6">
            <ul class="list-inline mb-0 mt-2 mt-md-0 text-center text-md-right">
              <li class="list-inline-item">
                <img src="../public/assets/images/visa.svg" alt="..." class="payment-icon">
              </li>
              <li class="list-inline-item">
                <img src="../public/assets/images/mastercard.svg" alt="..." class="payment-icon">
              </li>
              <li class="list-inline-item">
                <img src="../public/assets/images/paypal.svg" alt="..." class="payment-icon">
              </li>
            </ul>
          </div>
        </div>
